...
def analyze_stock_performance(row):
    prompt = f"""
   As a highly skilled financial analyst with expertise in equity research and stock performance evaluation, you are tasked with predicting the stock performance of a company in 2020 based on its financial data from 2016, 2017, 2018 and 2019. You are not allowed to analyse anything beyond the end of 2019. So the test is unbiased
   **You are allowed to research external financial news, market sentiment, industry trends, and macroeconomic conditions for 2016-2019 to improve your prediction.** However, you are NOT allowed to use any data or knowledge beyond December 31, 2019.
    ...
    Given the financial data for 2016, 2017, 2018 and 2019

### **2019 Financial Data**
- Instrument: {row['Instrument']}
- Company Name: {row['Company_Common_Name']}
- Exchange Name 2018: {row['Exchange_Name']}
- Revenue 2019: {row['Total_Revenue_2019']}
- Net Income 2019: {row['Net_Income_Incl_Extra_Before_Distributions_2019']}
- EBITDA 2019: {row['EBITDA_2019']}
- Gross Profit 2019: {row['Gross_Profit_2019']}
- Operating Income 2019: {row['Operating_Income_2019']}
- Free Cash Flow 2019: {row['Free_Cash_Flow_2019']}
- Current Ratio 2019: {row['Current_Ratio_2019']}
- Quick Ratio 2019: {row['Quick_Ratio_2019']}
- Total Assets 2019: {row['Total_Assets_2019']}
- Current Assets 2019: {row['Current_Assets_2019']}
- Total Liabilities 2019: {row['Total_Liabilities_2019']}
- Current Liabilities 2019: {row['Current_Liabilities_2019']}
- Enterprise Value/EBITDA 2019: {row['Enterprise_Value_To_EBITDA_(Daily_Time_Series_Ratio)_2019']}
- Monthly Closing Prices 2019: [{row['CLOSE_2019_01']}, {row['CLOSE_2019_02']}, {row['CLOSE_2019_03']}, {row['CLOSE_2019_04']}, {row['CLOSE_2019_05']}, {row['CLOSE_2019_06']}, {row['CLOSE_2019_07']}, {row['CLOSE_2019_08']}, {row['CLOSE_2019_09']}, {row['CLOSE_2019_10']}, {row['CLOSE_2019_11']}, {row['CLOSE_2019_12']}]
- Monthly Trading Volumes 2019: [{row['VOLUME_2019_01']}, {row['VOLUME_2019_02']}, {row['VOLUME_2019_03']}, {row['VOLUME_2019_04']}, {row['VOLUME_2019_05']}, {row['VOLUME_2019_06']}, {row['VOLUME_2019_07']}, {row['VOLUME_2019_08']}, {row['VOLUME_2019_09']}, {row['VOLUME_2019_10']}, {row['VOLUME_2019_11']}, {row['VOLUME_2019_12']}]
